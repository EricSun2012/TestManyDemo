package com.robot.anyDemo.widget;
 ...
 * 类描述：
 * 创建人：Eric
 * 创建时间：2019-06-11 17:51
 * 修改人：Eric
 * 修改时间：2019-06-11 17:51
 * 修改备注：
 */
public class ProgressButton extends AppCompatButton {
    ...
    private void initialize(Context context, AttributeSet attrs) {
        ...
        int defaultButtonColor = getResources().getColor(R.color.md_cyan_400);
        //Get default progress color
        int defaultProgressColor = getResources().getColor(R.color.md_green_500);
        //Get default progress background color
        int defaultBackColor = getResources().getColor(R.color.md_cyan_400);
