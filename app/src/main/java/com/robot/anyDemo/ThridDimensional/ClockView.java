...
public class ClockView extends View {
    ...
    public ClockView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.MClockView, defStyleAttr, 0);
        mTextSize = ta.getDimension(R.styleable.MClockView_textSize, UIUtil.dip2px(14));
        mBackgroundColor = ta.getColor(R.styleable.MClockView_backgroundColor, Color.parseColor("#237EAD"));
        mLightColor = ta.getColor(R.styleable.MClockView_lightColor, Color.parseColor("#ffffff"));
        mDarkColor = ta.getColor(R.styleable.MClockView_darkColor, Color.parseColor("#80ffffff"));
        ta.recycle();
    ...
    private void drawTimeText() {
        ...
        mCanvas.drawText(timeText, getWidth() - mPaddingRight - mTextRect.height() / 2 - textSmallWidth / 2,
        ...
        for (int i = 0; i < 4; i++) {
            mCanvas.drawArc(mCircleRectF, 6 + 90 * i, 78, false, mCirclePaint);
        }
    }
    ...
    private void drawHourHand() {
        mCanvas.save();
        mCanvas.translate(mCanvasTranslateX * 1.1f, mCanvasTranslateY * 1.1f);
    ...
    private void drawMinuteHand() {
        mCanvas.save();
        mCanvas.translate(mCanvasTranslateX * 1.6f, mCanvasTranslateY * 1.6f);
